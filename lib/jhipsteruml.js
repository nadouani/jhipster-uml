...
const fs = require('fs'),
    ...
    filterOutUnchangedEntities = require('./entitiescreator').filterOutUnchangedEntities,
...
if (!options.force) {
  scheduledClasses = filterOutUnchangedEntities(scheduledClasses);
}
if (!options.toJdl) {
  exportToJSON(entities, scheduledClasses, parsedData);
